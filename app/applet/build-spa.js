...
// Process index HTML sections
let homeSections = extractMain(indexHtml);
// Remove hero and trust strip since we are rebuilding the hero to be sticky
...
// Fix logo link to just be visually non-scrolling or go top
finalHtml = finalHtml.replace(/<a href="#home" class="logo">/, '<a href="#" class="logo">');

// We need to keep active state logic handled by CSS or JS, I will remove hardcoded active classes.
